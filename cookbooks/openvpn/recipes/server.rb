...
ca_certificate = my_databag["server_certs"]["ca_certificate"]
server_certificate = my_databag["server_certs"]["server_certificate"]
server_key = my_databag["server_certs"]["server_key"]
server_private_key = my_databag["server_certs"]["server_private_key"]
